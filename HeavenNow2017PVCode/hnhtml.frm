...
Begin VB.Form Form1 
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      Enabled         =   -1  'True
      ScrollBars      =   2
      TextRTF         =   $"hntxt.frx":2225
   End
   Begin VB.Label Label1 
      Caption         =   $"hntxt.frx":22C2
      BeginProperty Font 
         Name            =   "宋体"
         Size            =   9
         Charset         =   134
...
sFind = InputBox("请输入要替换的字、词：", "Heaven Now TXT Word：替换内容I", sFind)
w = InputBox("请输入替换的字、词：", "Heaven Now TXT Word：替换II", sFind)
...
FileName = "Heaven Now TXT Word：未命名"
...
CommonDialog1.Filter = "文本文档（*txt）|*.txt|*.rtf|所有文件（*.*）|*.*"
...
Me.Caption = "Heaven Now TXT Word：" & FileName
...
Private Sub mnuFind_Click()
 ...
 sFind = InputBox("请输入要查找的字、词：", "Heaven Now TXT Word:查找", sFind)
...
w = InputBox("请输入所要的字体（全称）：", "Heaven Now TXT Word：字体")
RichTextBox1.Font = w
End Sub
